...
})(["position:relative;.count{display:block;position:relative;transition:all 3s;backface-visibility:hidden;}.count-enter{transform:scale(6) rotateX(0.9turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{transform:scale(4) rotateX(0.5turn);}"]); //  So these make sure the width of the number representing items in cart is same:
...
//# sourceMappingURL=_app.js.795421282d66ca8dc8bd.hot-update.js.map