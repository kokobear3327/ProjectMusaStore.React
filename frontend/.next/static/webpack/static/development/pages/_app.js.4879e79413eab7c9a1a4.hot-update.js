...
})(["position:relative;.count{display:block;position:relative;transition:all 0.7s;backface-visibility:hidden;}.count-enter{transform:scale(3) rotateX(0.9turn);}.count-enter-active{transform:rotateX(0);}.count-exit{top:0;position:absolute;transform:rotateX(0);}.count-exit-active{transform:scale(4) rotateX(0.5turn);}"]); //  So these make sure the width of the number representing items in cart is same:
...
//# sourceMappingURL=_app.js.4879e79413eab7c9a1a4.hot-update.js.map