...
var _jsxFileName = "/Users/Programming_Work_2/Desktop/mod4.2/mod3/frontend/components/CreateItem.js";
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                files = e.target.files; // part of the JS language bra 👍

                data = new FormData();
                data.append('file', files[0]);
                data.append('upload_preset', 'projectmusa');
                _context.next = 7;
                return fetch('https://api.cloudinary.com/v1_1/project-musa/image/upload', {
                  method: 'POST',
                  body: data
                });
              ...
              case 10:
                file = _context.sent;
                console.log(file); // Now we gotta put the data back into those spots in our state.
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 5:
                      ...
                      console.log(res); // This is how you would route it to the specific page that you want!
...
var _jsxFileName = "/Users/Programming_Work_2/Desktop/mod4.2/mod3/frontend/pages/admin.js";
